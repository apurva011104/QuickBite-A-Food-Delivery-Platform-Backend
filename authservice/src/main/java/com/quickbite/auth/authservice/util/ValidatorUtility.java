...
public class ValidatorUtility {
    ...
    public static void validatePassword(String password) throws InvalidPasswordException{
        if(!password.matches(PASSWORD_REGEX)){
            throw new InvalidPasswordException("Password must contain at least one uppercase letter, one lowercase letter, one digit and must be at least eight characters long.");
        }
    }
}
